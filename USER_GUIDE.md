...
pip3 install --pre torch==2.5.0.dev20240825+cpu -f https://download.pytorch.org/whl/nightly/torch
pip3 install 'torch_xla[tpu] @ https://storage.googleapis.com/pytorch-xla-releases/wheels/tpuvm/torch_xla-2.5.0.dev20240825-cp310-cp310-linux_x86_64.whl' -f https://storage.googleapis.com/libtpu-releases/index.html
